...
VALUES 
('CLI001', 'Javier', NULL, 'Condor', NULL, 'Javier Condor', '0702996502', 'Av 9 Octubre 729 y Boyaca', '0229809800', '0992996500', 'ventas@elrosado.com.ec', 'NOR', 'ACT');
...
CREATE TABLE FACTURAS (
   ...
   CONSTRAINT FK_FACTURAS_CLICODIGO FOREIGN KEY (CLIIDENTIFICACION) REFERENCES CLIENTES (CLIIDENTIFICACION),
   ...
   CONSTRAINT CK_FACSTATUS CHECK (FACSTATUS IN ('PEN', 'PAG', 'CANC', 'ANU'))
);
DROP TABLE FACTURAS;

INSERT INTO FACTURAS (
   FACNUMERO, CLIIDENTIFICACION, FACFECHA, FACSUBTOTAL, FACDESCUENTO, FACIVA, FACICE, FACFORMAPAGO, FACSTATUS
) VALUES 
   ('FAC000001', '0702996502', '2024-06-01', 100.00, 10.00, 12.00, 0.00, 'EFECT', 'PAG'),
   ('FAC000002', '0602996504', '2024-06-02', 200.00, 20.00, 24.00, 0.00, 'TARCR', 'PEN'),
   ('FAC000003', '2102996506', '2024-06-03', 300.00, 30.00, 36.00, 0.00, 'TRANS', 'PAG');
...
-- Registros de ejemplo para la tabla PXF
INSERT INTO PXF (
   FACNUMERO, PROCODIGO, PXFCANTIDAD, PXFVALOR, PXFSUBTOTAL, PXFSTATUS
) VALUES 
   ('FAC000001', 'P-0001', 10.00, 1.00, 10.00, 'ACT'),
   ('FAC000002', 'P-0002', 20.00, 0.45, 9.00, 'ACT'),
   ('FAC000003', 'P-0003', 5.00, 5.00, 25.00, 'ACT');
